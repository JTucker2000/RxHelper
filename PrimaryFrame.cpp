...
void PrimaryFrame::initializeMainPageUI()
{
	...
	main_search_ui_panel->Bind(wxEVT_BUTTON, &PrimaryFrame::clearSearchButtonPress, this, CLEARSEARCHBTN_ID);
...
{
	patient_info_ui_panel->modifyPatient();
	patient_info_ui_panel->refreshPanel();
...
void PrimaryFrame::updatePatient(wxCommandEvent& event)
{
	patient_list_ui_panel->updatePatient();
}
